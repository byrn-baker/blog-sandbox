...
All VM data interfaces sit on the stretched `10.100.0.0/24` segment,
regardless of which DC the VM belongs to. Default gateway is the anycast
`10.100.0.1` on the fabric.

| VM | vmid | Mgmt (VLAN 3) | bond0 |
|----|------|---------------|-------|
| DCA-k3s-m1 | 3001 | 192.168.3.63 | 10.100.0.10/24 |
| DCA-k3s-m2 | 3002 | 192.168.3.64 | 10.100.0.11/24 |
| DCA-k3s-m3 | 3003 | 192.168.3.65 | 10.100.0.12/24 |
| DCB-k3s-w1 | 3004 | 192.168.3.66 | 10.100.0.20/24 |
| DCB-k3s-w2 | 3005 | 192.168.3.67 | 10.100.0.21/24 |
| DCB-k3s-w3 | 3006 | 192.168.3.68 | 10.100.0.22/24 |
| DCC-k3s-w4 | 3007 | 192.168.3.69 | 10.100.0.30/24 |
| DCC-k3s-w5 | 3008 | 192.168.3.70 | 10.100.0.31/24 |
| DCA-DNS | 3009 | 192.168.3.71 | 10.100.0.53/24 |
| DCC-k3s-w6 | 3010 | 192.168.3.72 | 10.100.0.32/24 |
